...
const Header = (props: {
  ...
  // const [logoSrc, setLogoSrc] = useState('/images/logo/logo_light.png');
  // useEffect(() => {
  //   const theme = localStorage.getItem('color-theme');
  //   if (theme === 'dark') {
  //     setLogoSrc('/images/logo/logo_dark.png');
  //   } else {
  //     setLogoSrc('/images/logo/logo_light.png');
  //   }
  // }, []);
  return (
    <header className="sticky top-0 z-99 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="px-2 py-3 md:ml-4">
        <Link href="/">
          <Image
